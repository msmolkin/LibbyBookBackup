2. [run python file to automatically download user's libby timeline](<using_code_interpreter/export_timeline.py>) (assumes that you are signed in in the browser)
